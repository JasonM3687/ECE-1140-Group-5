...
#				self.routes.append(self.routes[z]);
	...
	def GetDispatchInfo(self):
		...
		if(len(self.routes)>0):
			...
			self.SentSuggestedAuth= format(self.l5.get(0),"08b");
