...
//-------------------- Digital Output/Input Setup --------------------
  ...
  pinMode(6, OUTPUT);
  //Sets digital pin 4 as output (Open/Close Doors)
  pinMode(4, OUTPUT);
...
String setHeadlights() {
  ...
  if (read53 == HIGH) {
       ...
       headLights = "1";
       Serial.print("Headlights:" + headLights + "\n");
       return headLights;
  }
  else if (read53 == LOW) {
       digitalWrite(49,LOW);
...
String setInternalLights() {
  ...
  if (read52 == HIGH) {
      ...
      internalLights = "1";
      Serial.print("Internal Lights:" + internalLights + "\n");
...
void setServiceBrake() {
  ...
  if (read45 == HIGH) {
      ...
      serviceBrake = "1";
      Serial.print("Service Brake:" + serviceBrake + "\n");
      delay(3000);
      trainSpeed = "000";
  }
  else if (read45 == LOW) {
...
void setEmergencyBrake() {
 ...
 if (read5 == HIGH ) {
      ...
      emergencyBrake = "1'";
      Serial.print("Emergency Brake:" + emergencyBrake + "\n");
      digitalWrite(6, HIGH);
      //Waits 1/4 Sec
      delay(250);
...
void calculatePower() {
  ...
  changeMillis = currentMillis - startMillis;
...
void setKeypadLCD() {
  ...
  lcd.setCursor(0, 2);
  lcd.print("BCN: " + beacon);
  lcd.setCursor(0, 3);
  lcd.print("FS: " + faultStatus);
  lcd.setCursor(6, 0);
